...
bitcoin=pd.read_html('https://finance.yahoo.com/quote/BTC-USD/history?p=BTC-USD') 
...
def update_bbdd1(datos):
    for indice_fila, fila in df_carga.iterrows():
        ...
        if fecha[0] != '*':
            ...
            if fec_amd >= fecmax: 
                if error.endswith('Dividend')== False and error.endswith('-')== False:                    
                    dic['Date']=fec_amd
                    print(dic)
                    print(sep)
##!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! OJO !!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
...
##!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! OJO !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                     
#                if error.endswith('Dividend')== True:
                else:    
                    print(error)  
                    print(sep)
